...
export default function Quadrantes() {
  ...
  const lobp = { x1: 750, y1: 1000, x2: 1500, y2: 1000 };
  // ================================================================
  ...
  let pahav1 = getIntersection(
    { x: lav.x1, y: lav.y1 },
    { x: lav.x2, y: lav.y2 },
    { x: lqha1.x1, y: lqha1.y1 },
    { x: lqha1.x2, y: lqha1.y2 }
  );

  let pahav2 = getIntersection(
    { x: lav.x1, y: lav.y1 },
    { x: lav.x2, y: lav.y2 },
    { x: lqha2.x1, y: lqha2.y1 },
    { x: lqha2.x2, y: lqha2.y2 }
  );
  let pahbv1 = getIntersection(
    { x: lbv.x1, y: lbv.y1 },
    { x: lbv.x2, y: lbv.y2 },
    { x: lqhb1.x1, y: lqhb1.y1 },
    { x: lqhb1.x2, y: lqhb1.y2 }
  );

  let pahbv2 = getIntersection(
    { x: lbv.x1, y: lbv.y1 },
    { x: lbv.x2, y: lbv.y2 },
    { x: lqhb2.x1, y: lqhb2.y1 },
    { x: lqhb2.x2, y: lqhb2.y2 }
  );

  let pahcv1 = getIntersection(
    { x: lcv.x1, y: lcv.y1 },
    { x: lcv.x2, y: lcv.y2 },
    { x: lqhc1.x1, y: lqhc1.y1 },
    { x: lqhc1.x2, y: lqhc1.y2 }
  );

  let pahcv2 = getIntersection(
    { x: lcv.x1, y: lcv.y1 },
    { x: lcv.x2, y: lcv.y2 },
    { x: lqhc2.x1, y: lqhc2.y1 },
    { x: lqhc2.x2, y: lqhc2.y2 }
  );

   let pahdv1 = getIntersection(
    { x: ldv.x1, y: ldv.y1 },
    { x: ldv.x2, y: ldv.y2 },
    { x: lqhd1.x1, y: lqhd1.y1 },
    { x: lqhd1.x2, y: lqhd1.y2 }
  );

  let pahdv2 = getIntersection(
    { x: ldv.x1, y: ldv.y1 },
    { x: ldv.x2, y: ldv.y2 },
    { x: lqhd2.x1, y: lqhd2.y1 },
    { x: lqhd2.x2, y: lqhd2.y2 }
  );
